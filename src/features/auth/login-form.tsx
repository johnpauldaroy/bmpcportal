  ...
  return (
    <form className="mt-6 grid gap-4" onSubmit={handleSubmit(onSubmit)}>
      <label className="grid gap-1 text-sm font-medium text-[#344456]">
        Email Address
        <input
          className="focus-ring min-h-11 rounded-lg border border-[#cbd7e3] px-3 bg-white transition-colors focus:border-[#136f63]"
          type="email"
          autoComplete="email"
      ...
      <label className="grid gap-1 text-sm font-medium text-[#344456]">
        ...
        <div className="relative">
          <input
            className="focus-ring min-h-11 w-full rounded-lg border border-[#cbd7e3] px-3 pr-11 bg-white transition-colors focus:border-[#136f63]"
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8a99a8] hover:text-[#344456]"
