    ...
    <>
      ...
      <div className="grid gap-6">
        <section className="rounded-xl border border-[#E2E8F0] bg-white p-5 md-elevation-1">
          <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#3673FC]">
            Your referral code
          </p>
          <p className="mt-3 w-fit rounded-lg border border-dashed border-[#E2E8F0] bg-[#F8FAFC] px-4 py-3 font-mono text-2xl font-semibold text-[#0F172A]">
        ...
        <section className="grid gap-4">
          <h2 className="text-base font-semibold text-[#0F172A]">Referral history</h2>
