...
export default async function AccountPendingPage() {
  ...
  return (
    <AppShell>
      <section className="mx-auto max-w-xl rounded-xl border border-[#E2E8F0] bg-white p-6 text-center shadow-sm">
        <div className="mx-auto grid size-12 place-items-center rounded-full bg-[#DAE7FF] text-[#173DDE]">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <SignOutLinkButton />
          <Link className="inline-flex items-center text-sm font-semibold text-[#3673FC]" href="/">
            Return home
          </Link>
        </div>
      </section>
